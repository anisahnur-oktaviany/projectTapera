    ...
    <div class="row align-items-center g-lg-5 py-5">
        ...
        <div class="col-md-10 mx-auto col-lg-5">
            <form class="p-4 p-md-5 border rounded-3 bg-light" method="post" action="/users/profile">
                ...
                <div class="form-floating mb-3">
                    <input name="direktorat_name" type="text" class="form-control" id="direktorat_name" placeholder="direktorat name" value="<?= $model['user']['direktorat_name'] ?? '' ?>">
                    <label for="direktorat_name">Direktorat Name</label>
                </div>
                <div class="form-floating mb-3">
                    <input name="email" type="email" class="form-control" id="email" placeholder="email" value="<?= $model['user']['email'] ?? '' ?>">
